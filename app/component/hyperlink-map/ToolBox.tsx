...
import { Link2, X, TableOfContents, ChevronRight, Music2, SettingsIcon } from "lucide-react";
import Toc from "../toc";
  ...
  return (
    <>
      ...
      <aside className={clsx (
        ...
        absolute md:relative right-0 md:right-auto z-70 pointer-events-none h-full flex flex-col mt-0 md:mt-8 items-start text-sm gap-8 text-text-900 w-80 transition-all duration-200 ease-[cubic-bezier(0.75,0.05,0.45,0.95)] shrink-0`,

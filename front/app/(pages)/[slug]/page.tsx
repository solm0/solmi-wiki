...
export default async function Page({
  ...
  return (
    <>
      <div
        id="note_wrapper"
        className='flex gap-4 w-full pt-[40vh] text-text-900 break-normal md:break-keep overflow-y-scroll overflow-x-hidden custom-scrollbar focus:outline-0 pr-4'
      >
        {/* 본문 */}
        <Suspense>
          <Note post={post} />

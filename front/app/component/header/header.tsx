...
export default function Header() {
  return (
    <header className="fixed top-0 left-1/2 -translate-x-1/2 w-screen h-10 px-3 md:px-3 flex items-center justify-center z-60 transition-all duration-300 pt-2">

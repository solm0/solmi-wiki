...
import { Graph, GraphPost, Node } from '@/app/lib/type';
  ...
  useEffect(() => {
    const updateColors = () => {
      ...
      if (nodeGreen && text800 && text700) {
        setColors({nodeGreen: nodeGreen, text950: text950, text800: text800, text700: text700, text600: text600, bg: bg});
      }

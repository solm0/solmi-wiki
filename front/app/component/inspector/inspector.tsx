  ...
  return (
    <>
      ...
      <section
        ...
        isEnabled ? 'w-90 md:w-64 md:mr-7 shadow-2xl md:shadow-none translate-x-0 opacity-100 pointer-events-auto flex pl-4 md:pl-5' : 'w-0 -translate-x-88 opacity-0 pointer-events-none flex',
